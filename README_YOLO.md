...
A wide range of custom functions for YOLOv4 and YOLOv3 implemented in TensorFlow.
...
# Run yolov4 on video
python detect_video.py --weights ./checkpoints/yolov4-416 --video ./data/video/video.mp4 --output ./detections/results.avi

# Run yolov4 on webcam
python detect_video.py --weights ./checkpoints/yolov4-416 --video 0 --output ./detections/results.avi
```
If you want to run yolov3 change ``--model yolov3`` and .weights file in above commands.
